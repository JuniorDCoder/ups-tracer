      ...
      <div class="card">
        <div class="card-body">
          ...
          <form method="post" action="add-tracking.php" class="forms-sample">
            ...
            <div class="form-group">
              <label for="exampleInputEmail1">Courier Fee</label>
              <input type="text" class="form-control" value="<?php echo $senderscontact ?>" name="scontact" id="exampleInputEmail1" placeholder="Courier Fee">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="exampleInputPassword1">Origin Port Location</label>
        ...
        <div class="card-body">
          ...
          <p class="card-description">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" value="<?php echo $receiverscontact ?>" name="rcontact" id="exampleInputEmail1" placeholder="Total Shipment Weight">
            </div>
            <div class="form-group">
