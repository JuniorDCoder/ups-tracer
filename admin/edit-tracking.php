       ...
       $des = text_input($_POST['desc']);
	     ...
	     if (empty($sendersname) || empty($senderscontact) || empty($sendersmail) || empty($sendersaddress) || empty($receiversname) || empty($receiverscontact) || empty($receiversmail) || empty($receiversaddress) || empty($status) || empty($dispatchl) || empty($dispatch) || empty($delivery) ) {
	       echo "<script>alert('Check !!! Some fields are empty')</script>";
	     	 ...
	     	 $update = mysqli_query($link, "UPDATE tracking SET sender_name = '$sendersname', sender_contact = '$senderscontact', sender_email = '$sendersmail', sender_address = '$sendersaddress', status = '$status', dispatch_location = '$dispatchl', receiver_email = '$receiversmail', receiver_name = '$receiversname', receiver_contact = '$receiverscontact', receiver_address = '$receiversaddress', dispatch_date = '$dispatch', delivery_date = '$delivery', current_location = '$current_lo', pdesc = '$des' WHERE tracking_number = '$tnumbs' ");
	     	 echo "<script>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form method="post" action="edit-tracking.php?num=<?php echo $tnumbs ?>" class="forms-sample">
            ...
            <div class="form-group">
              <label for="exampleInputEmail1">Curier Fee</label>
              <input type="text" class="form-control" value="<?php echo $senders_contact ?>" name="scontact" id="exampleInputEmail1" placeholder="Courier Fee">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="status">
              	...
              	<option value="In Transit">Active</option>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <p class="card-description">
            ...
            <div class="form-group">
              <label for="exampleInputEmail1">Total Shipment Weight</label>
              <input type="text" class="form-control" value="<?php echo $receivers_contact ?>" name="rcontact" id="exampleInputEmail1" placeholder="weight">
            </div>
            <div class="form-group">
           ...
           <div class="form-group">
              ...
              <input type="date" class="form-control" name="dispatch" value="<?php echo $dispatchh ?>" id="exampleInputPassword1" placeholder="Dispatch Date">
            </div>
          	<div class="form-group">
              <label for="exampleInputPassword1">Estimated Delivery Date</label>
              <input type="date" class="form-control" value="<?php echo $deliveryy ?>" name="delivery" id="exampleInputPassword1" placeholder="Estimated Delivery Date">
            </div>
        </div>
      </div>
    </div>
